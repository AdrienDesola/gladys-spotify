= Gladys Spotify image:/docs/assets/spotify-connect.jpg[alt="spotify-login.png", width=100]
...
= Troubleshooting
If raspotify doesn't broadcast, try edit /etc/default/raspotify
Add/Modify :
	OPTIONS="--device hw:0" (0 is number of your audio card)
and
